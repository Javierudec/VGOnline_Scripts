 ...
 * 
 * [ACT](RC):[Counter Blast (1) & Put this unit into your soul] 
 * Look at the top five cards of your deck, search for up to one 
 * grade 3 or greater «Genesis» from among them, reveal it to your 
 * opponent, put it into your hand, and shuffle your deck.
 */

public class VividRabbit : UnitObject {
		...
		DelayUpdate(delegate {
			...
			delegate {
				...
				GetDeck().ViewDeck(1, SearchMode.TOP_CARD, min (5, GetDeck().Size()), delegate(Game2DCard c) {
					return c._CardInfo.BelongsToClan("Genesis") && c._CardInfo.grade >= 3;
				});
			});
		});
