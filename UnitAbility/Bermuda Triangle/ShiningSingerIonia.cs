 ...
 * 
 * [AUTO](RC):When this unit attacks a vanguard, if you have a 
 * «Bermuda Triangle» vanguard, this unit gets [Power]+2000 until end of 
 * that battle.
 */

public class ShiningSingerIonia : UnitObject {
	public override void Auto (CardState cs, Card ownerEffect)
	{
		if(cs == CardState.Attacking)
		{
			...
			if(RC () && GetDefensor().IsVanguard() && VanguardIs("Bermuda Triangle"))
			{
