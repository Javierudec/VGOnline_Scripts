 ...
 * If the revealed card is a grade 1 or 2 «Nova Grappler», 
 * call that card to (RC), and if it is not, shuffle your deck.
 */

public class Transraizer : UnitObject {
	...
	public override void Update ()
	{
		DelayUpdate(delegate {
			...
			{
				UnsetBool(1);
				if(_AuxCard1 != null && _AuxCard1.BelongsToClan("Nova Grappler") && (_AuxCard1.grade == 1 || _AuxCard1.grade == 2))
				{
